...
from insurance_app.controller.insurance_controller import MarketerController
...
class insurance_sell_view:
    ...
    def submit_form(self):
        ...
        status, insurance = MarketerController.save(f"{first_name} {last_name}", combo_gender, national_code,
