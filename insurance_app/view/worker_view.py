...
from insurance_app.controller.insurance_controller import WorkerController
...
class insurance_sell_view:
    ...
    def submit_form(self):
        ...
        status, insurance = WorkerController.save(f"{first_name} {last_name}", combo_gender, national_code,
